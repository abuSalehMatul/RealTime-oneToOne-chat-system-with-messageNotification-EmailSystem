...
class PageController extends Controller
{
    ...
    public function membership(Request $request)
    {
        ...
        return view('pages.admin.premembership',['share'=>$share,'isAdmin'=>$isAdmin,'professions'=>$professions,'avatar'=>$avatar[0]['avatar']]);
    }
    ...
    public function user_access_search(Request $request){
        ...
        if ($request->ajax()) {
            ...
            if ($users) {
                ...
                $output = '<div style="overflow-y:scroll;z-index:2;height:500px;">' . $output . '</div>';
                return Response($output);
