...
.tree-children {transition: all .3s;}
.tree-node { white-space:nowrap; }
.tree-anchor { display:inline-block; color:black; white-space:nowrap; padding:0 0 0 0; margin:0; vertical-align:top; font-size: 14px; cursor: pointer;} // padding:0 4px 0 1px;
...
.drop-0 { background-color: inherit; }
.drop-1 { border-top: 2px solid #C9FDC9; }
.drop-2 { background-color: #C9FDC9 ! important;}
.drop-3 { border-bottom: 2px solid #C9FDC9; }
